"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[4358],{5002:function(e,t,n){n.d(t,{Bt:function(){return sb},ET:function(){return sN},IO:function(){return si},JU:function(){return iL},PL:function(){return sI},QT:function(){return sE},Xo:function(){return su},ad:function(){return iO},ar:function(){return sa},b9:function(){return sc},hJ:function(){return ix},oe:function(){return sA},pl:function(){return sC},r7:function(){return sS}});var r,i,s,a,o=n(8885),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nZ{constructor(){this.ao=()=>this.uo(),this.co=()=>this.lo(),this.ho=[],this.Po()}_o(e){this.ho.push(e)}shutdown(){window.removeEventListener("online",this.ao),window.removeEventListener("offline",this.co)}Po(){window.addEventListener("online",this.ao),window.addEventListener("offline",this.co)}uo(){for(let e of(v("ConnectivityMonitor","Network connectivity changed: AVAILABLE"),this.ho))e(0)}lo(){for(let e of(v("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE"),this.ho))e(1)}static D(){return"undefined"!=typeof window&&void 0!==window.addEventListener&&void 0!==window.removeEventListener}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sE(e){e=iA(e,iD);let t=iA(e.firestore,iM);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new id({next:s=>{t.enqueueAndForget(()=>rq(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rK(new e8(n.path),s,{includeMetadataChanges:!0,_a:!0});return rU(e,a)})(await iv(e),e.asyncQueue,t,n,r)),r.promise})(iF(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new sT(e);return new sw(e,i,t._key,r,new sy(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class sT extends sp{constructor(e){super(),this.firestore=e}convertBytes(e){return new iU(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iD(this.firestore,null,t)}}function sI(e){e=iA(e,ib);let t=iA(e.firestore,iM),n=iF(t),r=new sT(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new S(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new rK(n,new id({next:n=>{t.enqueueAndForget(()=>rq(e,s)),n.fromCache&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),{includeMetadataChanges:!0,_a:!0});return rU(e,s)})(await iv(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new s_(t,r,e,n)))}function sC(e,t,n){e=iA(e,iD);let r=iA(e.firestore,iM),i=sg(e.converter,t,n);return sk(r,[iX(iY(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tx.none())])}function sS(e,t,n,...r){e=iA(e,iD);let i=iA(e.firestore,iM),s=iY(i);return sk(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iq?function(e,t,n,r,i,s){let a=e.Nu(1,t,n),o=[i4(t,r,n)],l=[i];if(s.length%2!=0)throw new S(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i4(t,s[e])),l.push(s[e+1]);let u=[],c=eO.empty();for(let e=o.length-1;e>=0;--e)if(!i6(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Cu(t);if(n instanceof iJ)u.push(t);else{let e=i0(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iQ(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Nu(1,t,n);i3("Data must be an object, but it was:",i,r);let s=[],a=eO.empty();return ee(r,(e,r)=>{let o=i8(t,e,n);r=(0,h.m9)(r);let l=i.Cu(o);if(r instanceof iJ)s.push(o);else{let e=i0(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iQ(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tx.exists(!0))])}function sA(e){return sk(iA(e.firestore,iM),[new tz(e._key,tx.none())])}function sN(e,t){let n=iA(e.firestore,iM),r=iL(e),i=sg(e.converter,t);return sk(n,[iX(iY(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,tx.exists(!1))]).then(()=>r)}function sk(e,t){return function(e,t){let n=new A;return e.asyncQueue.enqueueAndForget(async()=>r3(await iw(e).then(e=>e.syncEngine),t,n)),n.promise}(iF(e),t)}function sb(){return new iZ("serverTimestamp")}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iM(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ew(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.0",void 0),(0,o.KN)(m,"4.7.0","esm2017")}()}}]);