...
- `_redirects` — Netlify SPA fallback config

## After deployment

The site will look great immediately, with tasteful warm placeholders where photos/videos go. To make forms and login actually save data:
...
3. Upload your photos and videos to Firebase Storage per the upload table
