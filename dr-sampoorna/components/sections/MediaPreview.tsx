...
import { NEWS_VIDEOS } from "@/lib/content";
            ...
            >
              <div className="relative aspect-video bg-chocolate-deep grain overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <span className="w-14 h-14 rounded-full bg-gold-shine flex items-center justify-center text-chocolate-deep group-hover:scale-110 transition-transform shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
